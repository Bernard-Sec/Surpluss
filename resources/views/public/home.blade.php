        ...
        <div class="container py-5">
                ...
                <div class="col-lg-6 z-2">
                    <div class="pe-lg-5">
                        <div class="d-inline-flex align-items-center bg-white border border-success border-opacity-10 rounded-pill px-3 py-2 mb-4 shadow-sm">
                            <span class="badge bg-success rounded-pill me-2">{{ __('home.badge_new') }}</span>
                            <span class="text-success fw-bold small ls-1" style="font-size: 0.75rem;">{{ __('home.badge_revolution') }}</span>
                        </div>

                        <h1 class="display-3 fw-bold mb-4 text-dark lh-sm">
                            {{ __('home.hero_title_1') }} <br>
                            <span class="text-gradient-primary">{{ __('home.hero_title_2') }}</span>
                        </h1>
                        ...
                        <div class="d-flex flex-wrap gap-3 mb-5">
                            ...
                            <a href="{{ route('how') }}" class="btn-outline-custom text-decoration-none">
                                <i class="bi bi-play-circle me-2"></i> {{ __('home.btn_how') }}
                            </a>
                        </div>
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <span class="text-muted small fw-semibold">{{ __('home.hero_stat_text') }}</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="mockup-container">
                        ...
                        <div class="glass-card float-item" style="top: 10%; right: 10%; width: 280px; --r: -5deg; z-index: 2;">
                            <div class="d-flex align-items-center p-3">
                                ...
                                <div>
                                    <div class="fw-bold text-dark">{{ __('home.card_donate') }}</div>
                                    <div class="small text-muted">{{ __('home.card_donate_desc') }}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="glass-card float-item" style="top: 40%; right: 0%; width: 300px; --r: 5deg; z-index: 3; animation-delay: 1s;">
                            <div class="d-flex align-items-center p-3">
                                ...
                                <div>
                                    <div class="fw-bold text-dark">{{ __('home.card_request') }}</div>
                                    <div class="d-flex align-items-center mt-1">
                                        <small class="text-muted fw-bold">{{ __('home.card_request_desc') }}</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="glass-card float-item" style="top: 70%; right: 15%; width: 260px; --r: -3deg; z-index: 4; animation-delay: 2s;">
                            <div class="d-flex align-items-center p-3">
                                ...
                                <div>
                                    <div class="fw-bold text-dark">{{ __('home.card_received') }}</div>
                                    <div class="small text-muted">{{ __('home.card_received_desc') }}</div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12">
                    <div class="impact-strip d-flex flex-wrap justify-content-around align-items-center text-center">
                        <div class="p-3">
                            ...
                            <div class="stat-label">{{ __('home.stat_food_label') }}</div>
                        </div>
                        <div class="d-none d-md-block vr opacity-25" style="height: 50px;"></div>
                        <div class="p-3">
                            <div class="stat-number mb-2">Rp 5 M+</div>
                            <div class="stat-label">{{ __('home.stat_money_label') }}</div>
                        </div>
                        <div class="d-none d-md-block vr opacity-25" style="height: 50px;"></div>
                        <div class="p-3">
                            <div class="stat-number mb-2">25 Ton</div>
                            <div class="stat-label">{{ __('home.stat_co2_label') }}</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-5 py-4">
                <div class="col-12 text-center">
                    <p class="text-uppercase text-muted fw-bold small ls-2 mb-4">{{ __('home.trusted_text') }}</p>
                    ...
                    <div class="bento-box glass-card bg-white">
                        ...
                        <div class="position-relative z-1">
                            <div class="d-flex align-items-center mb-4">
                                ...
                                <h3 class="fw-bold text-dark m-0">{{ __('home.why_title') }}</h3>
                            </div>
                            <p class="text-secondary fs-5 mb-0 lh-base">
                                {!! __('home.why_desc') !!}
                                <br><br>
                                <span class="d-flex align-items-center gap-2">
                                    <i class="bi bi-check-circle-fill text-success"></i> {{ __('home.why_point_1') }}
                                    <i class="bi bi-check-circle-fill text-success ms-3"></i> {{ __('home.why_point_2') }}
                                </span>
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-lg-5">
                    <div class="bento-box border-0 d-flex flex-column justify-content-center text-white" 
                        ...
                        <div class="position-relative z-1 text-center text-lg-start">
                            <h3 class="fw-bold mb-3">{{ __('home.cta_title') }}</h3>
                            ...
                            <a href="{{ route('register') }}" class="btn bg-white text-success fw-bold rounded-pill px-4 py-3 w-100 shadow-sm" style="font-size: 1.1rem; transition: transform 0.2s;">
                                {{ __('home.cta_btn') }} <i class="bi bi-arrow-right ms-2"></i>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-4 pb-5 mb-5">
                <div class="col-12 text-center mb-4">
                    ...
                    <h2 class="fw-bold mt-2">{{ __('home.cat_title') }}</h2>
                </div>

                <div class="col-md-3 col-6">
                    <div class="cat-card">
                        <div class="cat-icon"><i class="bi bi-cup-hot-fill"></i></div>
                        <h5 class="fw-bold mb-2">{{ __('home.cat_bread') }}</h5>
                        <p class="text-muted small mb-0">{{ __('home.cat_bread_desc') }}</p>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-6">
                    <div class="cat-card">
                        ...
                        <h5 class="fw-bold mb-2">{{ __('home.cat_rice') }}</h5>
                        <p class="text-muted small mb-0">{{ __('home.cat_rice_desc') }}</p>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-6">
                    <div class="cat-card">
                        ...
                        <h5 class="fw-bold mb-2">{{ __('home.cat_fresh') }}</h5>
                        <p class="text-muted small mb-0">{{ __('home.cat_fresh_desc') }}</p>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-6">
                    <div class="cat-card">
                        ...
                        <h5 class="fw-bold mb-2">{{ __('home.cat_snack') }}</h5>
                        <p class="text-muted small mb-0">{{ __('home.cat_snack_desc') }}</p>
                    </div>
                </div>
            </div>
